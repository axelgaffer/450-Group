...
public class ReLogoObserver extends BaseObserver{
	...
	/**
	 * Makes a number of randomly oriented spawners and then executes a set of commands on the
	 * created spawners.
	 * 
	 * @param number
	 *            a number
	...
	public AgentSet<zombies.relogo.Spawner> createSpawners(int number, Closure closure) {
		AgentSet<zombies.relogo.Spawner> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.crt(number,closure,"Spawner");
		for (Turtle t : createResult){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("zombies.relogo.Spawner")
	public AgentSet<zombies.relogo.Spawner> createSpawners(int number) {
		return createSpawners(number,null);
	}

	/**
	 * Makes a number of uniformly fanned spawners and then executes a set of commands on the
	 * created spawners.
	 * 
	 * @param number
	 *            a number
	 ...
	 */
	@ReLogoBuilderGeneratedFor("zombies.relogo.Spawner")
	public AgentSet<zombies.relogo.Spawner> createOrderedSpawners(int number, Closure closure) {
		AgentSet<zombies.relogo.Spawner> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.cro(number,closure,"Spawner");
		for (Turtle t : createResult){
			if (t instanceof zombies.relogo.Spawner){
				result.add((zombies.relogo.Spawner)t);
			}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("zombies.relogo.Spawner")
	public AgentSet<zombies.relogo.Spawner> createOrderedSpawners(int number) {
		return createOrderedSpawners(number,null);
	}
	...
	public AgentSet<zombies.relogo.Spawner> spawners(){
		...
		for (Object e : this.getContext().getObjects(zombies.relogo.Spawner.class)) {
	...
	public AgentSet<zombies.relogo.Spawner> spawnersOn(Patch p){
		...
		for (Turtle t : Utility.getTurtlesOnGridPoint(p.getGridLocation(),this,"spawner")){
			if (t instanceof zombies.relogo.Spawner)
			result.add((zombies.relogo.Spawner)t);
		}
		return result;
	...
	public AgentSet<zombies.relogo.Spawner> spawnersOn(Turtle t){
		AgentSet<zombies.relogo.Spawner> result = new AgentSet<zombies.relogo.Spawner>();						
		for (Turtle tt : Utility.getTurtlesOnGridPoint(Utility.ndPointToGridPoint(t.getTurtleLocation()),this,"spawner")){
	...
	/**
	 * Makes a number of randomly oriented spawner2OutsideIns and then executes a set of commands on the
	...
	public AgentSet<zombies.relogo.Spawner2OutsideIn> createSpawner2OutsideIns(int number, Closure closure) {
		AgentSet<zombies.relogo.Spawner2OutsideIn> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.crt(number,closure,"Spawner2OutsideIn");
		for (Turtle t : createResult){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("zombies.relogo.Spawner2OutsideIn")
	public AgentSet<zombies.relogo.Spawner2OutsideIn> createSpawner2OutsideIns(int number) {
		return createSpawner2OutsideIns(number,null);
	}

	/**
	 * Makes a number of uniformly fanned spawner2OutsideIns and then executes a set of commands on the
	 * created spawner2OutsideIns.
	 * 
	 * @param number
	 *            a number
	 ...
	 */
	@ReLogoBuilderGeneratedFor("zombies.relogo.Spawner2OutsideIn")
	public AgentSet<zombies.relogo.Spawner2OutsideIn> createOrderedSpawner2OutsideIns(int number, Closure closure) {
		AgentSet<zombies.relogo.Spawner2OutsideIn> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.cro(number,closure,"Spawner2OutsideIn");
		for (Turtle t : createResult){
			if (t instanceof zombies.relogo.Spawner2OutsideIn){
				result.add((zombies.relogo.Spawner2OutsideIn)t);
			}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("zombies.relogo.Spawner2OutsideIn")
	public AgentSet<zombies.relogo.Spawner2OutsideIn> createOrderedSpawner2OutsideIns(int number) {
		return createOrderedSpawner2OutsideIns(number,null);
	}
	...
	public AgentSet<zombies.relogo.Spawner2OutsideIn> spawner2OutsideIns(){
		...
		for (Object e : this.getContext().getObjects(zombies.relogo.Spawner2OutsideIn.class)) {
	...
	public AgentSet<zombies.relogo.Spawner2OutsideIn> spawner2OutsideInsOn(Patch p){
		...
		for (Turtle t : Utility.getTurtlesOnGridPoint(p.getGridLocation(),this,"spawner2OutsideIn")){
			if (t instanceof zombies.relogo.Spawner2OutsideIn)
			result.add((zombies.relogo.Spawner2OutsideIn)t);
		}
		return result;
	...
	public AgentSet<zombies.relogo.Spawner2OutsideIn> spawner2OutsideInsOn(Turtle t){
		AgentSet<zombies.relogo.Spawner2OutsideIn> result = new AgentSet<zombies.relogo.Spawner2OutsideIn>();						
		for (Turtle tt : Utility.getTurtlesOnGridPoint(Utility.ndPointToGridPoint(t.getTurtleLocation()),this,"spawner2OutsideIn")){
	...
	/**
	 * Makes a number of randomly oriented spawner3BackToFronts and then executes a set of commands on the
	...
	public AgentSet<zombies.relogo.Spawner3BackToFront> createSpawner3BackToFronts(int number, Closure closure) {
		AgentSet<zombies.relogo.Spawner3BackToFront> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.crt(number,closure,"Spawner3BackToFront");
		for (Turtle t : createResult){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("zombies.relogo.Spawner3BackToFront")
	public AgentSet<zombies.relogo.Spawner3BackToFront> createSpawner3BackToFronts(int number) {
		return createSpawner3BackToFronts(number,null);
	}

	/**
	 * Makes a number of uniformly fanned spawner3BackToFronts and then executes a set of commands on the
	 * created spawner3BackToFronts.
	 * 
	 * @param number
	 *            a number
	 ...
	 */
	@ReLogoBuilderGeneratedFor("zombies.relogo.Spawner3BackToFront")
	public AgentSet<zombies.relogo.Spawner3BackToFront> createOrderedSpawner3BackToFronts(int number, Closure closure) {
		AgentSet<zombies.relogo.Spawner3BackToFront> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.cro(number,closure,"Spawner3BackToFront");
		for (Turtle t : createResult){
			if (t instanceof zombies.relogo.Spawner3BackToFront){
				result.add((zombies.relogo.Spawner3BackToFront)t);
			}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("zombies.relogo.Spawner3BackToFront")
	public AgentSet<zombies.relogo.Spawner3BackToFront> createOrderedSpawner3BackToFronts(int number) {
		return createOrderedSpawner3BackToFronts(number,null);
	}
	...
	public AgentSet<zombies.relogo.Spawner3BackToFront> spawner3BackToFronts(){
		...
		for (Object e : this.getContext().getObjects(zombies.relogo.Spawner3BackToFront.class)) {
	...
	public AgentSet<zombies.relogo.Spawner3BackToFront> spawner3BackToFrontsOn(Patch p){
		...
		for (Turtle t : Utility.getTurtlesOnGridPoint(p.getGridLocation(),this,"spawner3BackToFront")){
			if (t instanceof zombies.relogo.Spawner3BackToFront)
			result.add((zombies.relogo.Spawner3BackToFront)t);
		}
		return result;
	...
	public AgentSet<zombies.relogo.Spawner3BackToFront> spawner3BackToFrontsOn(Turtle t){
		AgentSet<zombies.relogo.Spawner3BackToFront> result = new AgentSet<zombies.relogo.Spawner3BackToFront>();						
		for (Turtle tt : Utility.getTurtlesOnGridPoint(Utility.ndPointToGridPoint(t.getTurtleLocation()),this,"spawner3BackToFront")){
	...
	/**
	 * Makes a number of randomly oriented spawner4Randoms and then executes a set of commands on the
	...
	public AgentSet<zombies.relogo.Spawner4Random> createSpawner4Randoms(int number, Closure closure) {
		AgentSet<zombies.relogo.Spawner4Random> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.crt(number,closure,"Spawner4Random");
		for (Turtle t : createResult){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("zombies.relogo.Spawner4Random")
	public AgentSet<zombies.relogo.Spawner4Random> createSpawner4Randoms(int number) {
		return createSpawner4Randoms(number,null);
	}

	/**
	 * Makes a number of uniformly fanned spawner4Randoms and then executes a set of commands on the
	 * created spawner4Randoms.
	 * 
	 * @param number
	 *            a number
	 ...
	 */
	@ReLogoBuilderGeneratedFor("zombies.relogo.Spawner4Random")
	public AgentSet<zombies.relogo.Spawner4Random> createOrderedSpawner4Randoms(int number, Closure closure) {
		AgentSet<zombies.relogo.Spawner4Random> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.cro(number,closure,"Spawner4Random");
		for (Turtle t : createResult){
			if (t instanceof zombies.relogo.Spawner4Random){
				result.add((zombies.relogo.Spawner4Random)t);
			}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("zombies.relogo.Spawner4Random")
	public AgentSet<zombies.relogo.Spawner4Random> createOrderedSpawner4Randoms(int number) {
		return createOrderedSpawner4Randoms(number,null);
	}
	...
	public AgentSet<zombies.relogo.Spawner4Random> spawner4Randoms(){
		...
		for (Object e : this.getContext().getObjects(zombies.relogo.Spawner4Random.class)) {
	...
	public AgentSet<zombies.relogo.Spawner4Random> spawner4RandomsOn(Patch p){
		...
		for (Turtle t : Utility.getTurtlesOnGridPoint(p.getGridLocation(),this,"spawner4Random")){
			if (t instanceof zombies.relogo.Spawner4Random)
			result.add((zombies.relogo.Spawner4Random)t);
		}
		return result;
	...
	public AgentSet<zombies.relogo.Spawner4Random> spawner4RandomsOn(Turtle t){
		AgentSet<zombies.relogo.Spawner4Random> result = new AgentSet<zombies.relogo.Spawner4Random>();						
		for (Turtle tt : Utility.getTurtlesOnGridPoint(Utility.ndPointToGridPoint(t.getTurtleLocation()),this,"spawner4Random")){
	...
	public AgentSet<zombies.relogo.UserTurtle> createUserTurtles(int number, Closure closure) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("zombies.relogo.UserTurtle")
	public AgentSet<zombies.relogo.UserTurtle> createUserTurtles(int number) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("zombies.relogo.UserTurtle")
	public AgentSet<zombies.relogo.UserTurtle> createOrderedUserTurtles(int number, Closure closure) {
		AgentSet<zombies.relogo.UserTurtle> result = new AgentSet<>();
	 ...
	 */
	@ReLogoBuilderGeneratedFor("zombies.relogo.UserTurtle")
	public AgentSet<zombies.relogo.UserTurtle> createOrderedUserTurtles(int number) {
	...
	public AgentSet<zombies.relogo.UserTurtle> userTurtles(){
		...
		for (Object e : this.getContext().getObjects(zombies.relogo.UserTurtle.class)) {
	...
	public AgentSet<zombies.relogo.Infection> infections(){
		...
		for (Object e : this.getContext().getObjects(zombies.relogo.Infection.class)) {
	...
	public zombies.relogo.Infection infection(Number oneEnd, Number otherEnd) {
		return (zombies.relogo.Infection)(this.getNetwork("Infection").getEdge(turtle(oneEnd),turtle(otherEnd)));
	}
	...
	public AgentSet<zombies.relogo.UserLink> userLinks(){
		...
		for (Object e : this.getContext().getObjects(zombies.relogo.UserLink.class)) {
	...
	public zombies.relogo.UserLink userLink(Number oneEnd, Number otherEnd) {
		return (zombies.relogo.UserLink)(this.getNetwork("UserLink").getEdge(turtle(oneEnd),turtle(otherEnd)));
	}
